...
namespace Yucca.ViewModels.Identity
{
    ...
    {
        [Required]
        [StringLength(100, ErrorMessage = "تعداد کاراکتر کلمه عبور بیش از حد مجاز است", MinimumLength = 6)]
        ...
        [Compare("NewPassword", ErrorMessage = "کلمه عبور و تکرار آن یکسان نمی باشد.")]
